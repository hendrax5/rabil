  ...
  "inline-flex items-center justify-center rounded-full border px-2.5 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1.5 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-all duration-200 overflow-hidden shadow-sm",
  {
    variants: {
      variant: {
        ...
        outline:
          "text-foreground [a&]:hover:bg-accent [a&]:hover:text-accent-foreground border-gray-200 dark:border-gray-700",
        success:
          "border-transparent bg-green-500 text-white [a&]:hover:bg-green-600 hover:shadow-md",
        warning:
          "border-transparent bg-amber-500 text-white [a&]:hover:bg-amber-600 hover:shadow-md",
        info:
          "border-transparent bg-blue-500 text-white [a&]:hover:bg-blue-600 hover:shadow-md",
      },
    },
    defaultVariants: {
      variant: "default",
